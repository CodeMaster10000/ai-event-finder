...
def test_add_participant_to_event_success(app,mock_app_service):
    event_title = "event_1"
...
def test_remove_participant_from_event_success(app, mock_app_service):
    event_title = "event_1"
    user_email = "participant@example.com"
    with app.test_request_context():
        resource = ParticipantResource()
...
def test_list_participants_success(app, mock_app_service):
